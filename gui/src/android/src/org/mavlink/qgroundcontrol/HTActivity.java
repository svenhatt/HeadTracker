package org.dlktdr.HeadTracker;
...
public class HTActivity extends QtActivity
{
    public  static int                                  BAD_DEVICE_ID = 0;
    private static HTActivity                           _instance = null;
    ...
    private static final String                         TAG = "HT_HTActivity";
    private static PowerManager.WakeLock                _wakeLock;
    private static final String                         ACTION_USB_PERMISSION = "org.mavlink.HeadTracker.action.USB_PERMISSION";
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        _wakeLock = pm.newWakeLock(PowerManager.SCREEN_BRIGHT_WAKE_LOCK, "HeadTracker");
        if(_wakeLock != null) {
            _wakeLock.acquire();
        } else {
	...
	if (_wifiMulticastLock == null)
            {
                ...
                _wifiMulticastLock = wifi.createMulticastLock("HeadTracker");
